...
@Config(modid = EFMTags.MODID, name = EFMTags.MODID + "/EnchantsAndPotions")
public class ConfigEnchantsPotions {
    ...
    static {
        EtFuturumConfigLoader.register(ConfigEnchantsPotions.class);
    }
}
